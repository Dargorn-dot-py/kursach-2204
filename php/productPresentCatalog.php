...
if ($row_count>0){
    ...
    for($i=0; $i < $row_count; $i++){
        ...
        <a href="#popup'.$id.'" class="flex-block popup-link">
            ...
            <div class="block__label" style="color: '.$brandColor.'; text-shadow: 0 0 3px #eee">'.$brand.'</div>
            <div class="block__name">'.$productName.'</div>
            <div class="block__cost">'.$cost.' <i style="font-size: 18px" class="fa fa-rub"></i></div>
        </a>
