                    ...
                    <div class="block__post">
                        <form action="news-form.php" method="post" enctype="multipart/form-data">
                            <div class="post__body">
                                <div><input name="NewsPicSource" type="file" class="post__input" id="author"> - изображение новости</div>
                                <div><input  name="NewsAuthor" type="text" class="post__input" id="author" placeholder="Автор"></div>
                                <div><input name="NewsName" type="text" class="post__input" id="logo" placeholder="Заголовок"></div>
                                <div><textarea name="NewsText" id="text" cols="30" rows="10" class="post__textarea" placeholder="Текст"></textarea></div>
