      ...
      <main class="main">
         <div class="content">
            <div class="content__container">
                <div class="catalog">
                    <div class="post-adm-link"><a href="news-form.php" class="post__btn" id="post">Добавить новость</a></div>
                    <div class="post-adm-link"><a href="product-form.php" class="post__btn" id="post">Добавить товар</a></div>
                </div>
            </div>
         </div>
